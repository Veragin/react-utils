...
export const getCategoryTitle = (category: TBannerSetCategory) =>
    BANNERSET_CATEGORY_LIST.find((c) => c.value === category)?.title ?? '';
...
export const BANNERSET_STATE = [
    { value: 'private_paid', type: 'private', title: _('Private paid') },
    { value: 'private_not_paid', type: 'private', title: _('Private not paid') },
    { value: 'before_review', type: 'draft', title: _('Before review') },
    { value: 'in_review', type: 'draft', title: _('Review') },
    { value: 'returned', type: 'draft', title: _('Returned') },
    { value: 'template_published', type: 'template', title: _('Template published') },
    { value: 'template_hidden', type: 'template', title: _('Template hidden') },
    { value: 'public_published', type: 'public', title: _('Public published') },
    { value: 'public_hidden', type: 'public', title: _('Public hidden') },
    { value: 'taken_review', type: 'taken', title: _('Taken review') },
    { value: 'taken_hidden', type: 'taken', title: _('Taken hidden') },
] as const;

export type TBannerSetState = (typeof BANNERSET_STATE)[number]['value'];
